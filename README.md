...
Защищай Землю от 50 волн врагов! Башня в центре автоматически стреляет.
На 20-й волне — босс: не умирает при касании ядра, а отбрасывается и атакует снова.
После убийства босса золото с врагов ×5.
Улучшения покупаются за золото, кристаллы за волны тратятся в магазине (до 10 уровней).
...
src/
  ...
  entities/enemy.js     — враги (HP, poison, смерть, отбрасывание босса)
  ...
  data/waves.js         — 50 волн и статы врагов
